...
<?php 
    ...
    $votreAge    = $_POST['age'];
        ...
        if(($votrePrenom) AND ($votreAge)) {     // Test de $_POST['prenom'] et $_POST['age'] - DEBUT 
...
<form method="post" action="">
    ...
    <p align="center">
        <input type="text" name="prenom" placeholder="Votre prenom" value="<?php if(!empty($votrePrenom)) { echo $votrePrenom; } ?>" />
    </p>
    <p align="center">
        <input type="text" name="age" placeholder="Votre age" value="<?php if(!empty($votreAge)) { echo $votreAge; }?>" />
    </p>
    <p align="center">
